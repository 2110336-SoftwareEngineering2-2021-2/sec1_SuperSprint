...
const names = ["Adam Benson", "Clare Donaldsdfadsfdsfson", "Phusaratis Jong", "Donald Clarkson"]
...
export default function Testpage() {
  ...
  for (let i = 0; i < 4; i++) {
    temp.push(<TutorCard
      key={i}
      name={names[i]}
      profileImg={'https://www.chicagotribune.com/resizer/a-16fPYl-SK8W6HPnzjOHK1rqho=/800x551/top/arc-anglerfish-arc2-prod-tronc.s3.amazonaws.com/public/IEYVMAFZ7BBXHM46GFNLWRN3ZA.jpg'}
