    ...
    return (
        <>
            ...
            <div className="form-control">
                <input type="text" placeholder="Search..." className="input text-black" value={tutureName} onInput={e => setTutureName(e.target.value)}></input>
            </div>
            </div> 
            <div className="flex-none">
            <button className="btn btn-square btn-ghost" onClick={submitSearching}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block w-6 h-6 stroke-current">             
