...
const Navbar = (props) => {
  ...
  return (
    <>
      {/* {closedrawer && ( */}
      <div className="drawer drawer-side top-bar fixed fixed h-screen w-full">
        <input
          id="my-drawer"
          type="checkbox"
        ...
        <div className="drawer-content relative mx-auto h-screen w-screen pb-10">
              ...
              <div className="flex-1 justify-start">
                <div className="form-control">
                  <input
                    type="text"
                    placeholder="Search..."
                    className="input text-base-content w-54 sm:w-96"
                    value={tutureName}
